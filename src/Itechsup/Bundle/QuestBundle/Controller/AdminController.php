...
class AdminController extends Controller
{
     ...
     * @Method("POST")
     * @Template("ItechsupQuestBundle:Questionnaire:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechsupQuestBundle:Questionnaire')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechsupQuestBundle:Questionnaire:edit.html.twig")
     */
