...
use Itechsup\Bundle\QuestBundle\Entity\Categorie;
use Itechsup\Bundle\QuestBundle\Form\CategorieType;
...
class CategorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechsupQuestBundle:Categorie')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechsupQuestBundle:Categorie:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechsupQuestBundle:Categorie')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechsupQuestBundle:Categorie:edit.html.twig")
     */
