...
use Itechsup\Bundle\QuestBundle\Form\QuestionType;
...
class QuestionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechsupQuestBundle:Question')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechsupQuestBundle:Question:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechsupQuestBundle:Question')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechsupQuestBundle:Question:edit.html.twig")
     */
